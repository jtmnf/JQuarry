...
public class NetherQuarry extends InitBlocks {
    ...
    public NetherQuarry(){
        super(Material.rock, Blocks.netherrack);
        this.setBlockName("netherQuarry");
    }
    ...
    public void registerBlockIcons(IIconRegister reg) {
        ...
        this.front = reg.registerIcon("jquarry:frontNether");
    }
