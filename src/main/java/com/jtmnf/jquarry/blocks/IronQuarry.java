...
public class IronQuarry extends InitBlocks {
    ...
    public IronQuarry(){
        super(Material.rock, Blocks.iron_ore);
        this.setBlockName("ironQuarry");
    }
    ...
    public void registerBlockIcons(IIconRegister reg) {
        ...
        this.front = reg.registerIcon("jquarry:frontIron");
    }
