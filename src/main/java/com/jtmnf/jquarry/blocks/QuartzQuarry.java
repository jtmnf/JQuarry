...
public class QuartzQuarry extends InitBlocks {
    ...
    public QuartzQuarry(){
        super(Material.rock, Blocks.quartz_ore);
        this.setBlockName("quartzQuarry");
    }
    ...
    public void registerBlockIcons(IIconRegister reg) {
        ...
        this.front = reg.registerIcon("jquarry:frontQuartz");
    }
