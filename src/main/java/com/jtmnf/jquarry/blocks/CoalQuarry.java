...
public class CoalQuarry extends InitBlocks {
    ...
    public CoalQuarry(){
        super(Material.rock, Blocks.coal_ore);
        this.setBlockName("coalQuarry");
    }
    ...
    public void registerBlockIcons(IIconRegister reg) {
        ...
        this.front = reg.registerIcon("jquarry:frontCoal");
    }
