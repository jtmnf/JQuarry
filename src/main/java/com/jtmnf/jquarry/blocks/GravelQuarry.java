...
public class GravelQuarry extends InitBlocks {
    ...
    public GravelQuarry(){
        super(Material.rock, Blocks.gravel);
        this.setBlockName("gravelQuarry");
    }
    ...
    public void registerBlockIcons(IIconRegister reg) {
        ...
        this.front = reg.registerIcon("jquarry:frontGravel");
    }
