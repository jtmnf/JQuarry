...
public class LapisQuarry extends InitBlocks {
    ...
    public LapisQuarry(){
        super(Material.rock, Blocks.lapis_ore);
        this.setBlockName("lapisQuarry");
    }
    ...
    public void registerBlockIcons(IIconRegister reg) {
        ...
        this.front = reg.registerIcon("jquarry:frontLapis");
    }
