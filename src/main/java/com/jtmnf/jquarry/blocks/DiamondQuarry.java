...
public class DiamondQuarry extends InitBlocks {
    ...
    public DiamondQuarry(){
        super(Material.rock, Blocks.diamond_ore);
        this.setBlockName("diamondQuarry");
    }
    ...
    public void registerBlockIcons(IIconRegister reg) {
        ...
        this.front = reg.registerIcon("jquarry:frontDiamond");
    }
